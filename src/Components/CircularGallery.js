...
import imagem1 from '../images/imagem-1.jpg';
import imagem2 from '../images/imagem-2.jpg';
import imagem3 from '../images/imagem-3.jpg';
import imagem4 from '../images/imagem-4.jpg';
import imagem5 from '../images/imagem-5.jpg';
...
class Media {
    ...
    this.program = new Program(this.gl, {
      ...
      vertex: `
        ...
        void main() {
          vUv = uv;
          vec3 p = position;
          p.z = (sin(p.x * 4.0 + uTime) * 1.0 + cos(p.y * 2.0 + uTime) * 1.0) * (0.1 + uSpeed * 0.3);
  ...
  onResize({ screen, viewport } = {}) {
    ...
    this.plane.scale.x = (this.viewport.width * ( 467 * this.scale)) / this.screen.width
